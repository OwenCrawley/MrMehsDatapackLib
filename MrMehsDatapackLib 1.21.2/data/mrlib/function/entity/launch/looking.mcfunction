...
execute store result entity @s Motion[0] double 0.00001 run scoreboard players operation $x2 mrlib.motion *= $strength mrlib.motion
execute store result entity @s Motion[1] double 0.00001 run scoreboard players operation $y2 mrlib.motion *= $strength mrlib.motion
execute store result entity @s Motion[2] double 0.00001 run scoreboard players operation $z2 mrlib.motion *= $strength mrlib.motion