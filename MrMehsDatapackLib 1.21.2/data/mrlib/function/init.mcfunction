tellraw @a {"text": "Mr Meh's Datapack Lib Initialized","color":"yellow"}
...
scoreboard objectives add mrlib.gamerule dummy
scoreboard objectives add mrlib.pos dummy
scoreboard objectives add mrlib.motion dummy
scoreboard objectives add mrlib.recursive dummy
##      --movement--
